...
//  Today
//
//  Created by Aleksandr Eliseev on 06.02.2023.
//
...
class ProgressHeaderView: UICollectionReusableView {
    ...
    private func prepareSubviews() {
        ...
        heightAnchor.constraint(equalTo: widthAnchor, multiplier: 1).isActive = true /// Fixed aspectRatio for the containerView
        ...
        // Custom height constraint for the lowerView
